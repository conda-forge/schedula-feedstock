...
Documentation: https://schedula.readthedocs.io/en/v1.2.10
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6786&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/schedula-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `schedula` can be installed with:

```
conda install schedula
```

It is possible to list all of the versions of `schedula` available on your platform with:
